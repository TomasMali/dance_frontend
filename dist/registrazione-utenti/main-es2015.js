...
/* harmony import */ var _user_registration_user_registration_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./user-registration/user-registration.component */ "./src/app/user-registration/user-registration.component.ts");
...
/* harmony import */ var _login_auth_guard__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./login/auth.guard */ "./src/app/login/auth.guard.ts");
/* harmony import */ var _login_auth_guardA__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./login/auth.guardA */ "./src/app/login/auth.guardA.ts");
...
const routes = [
    ...
    { path: 'myaccount', component: _myaccount_myaccount_component__WEBPACK_IMPORTED_MODULE_6__["MyaccountComponent"], canActivate: [_login_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
    { path: 'login', component: _login_login_component__WEBPACK_IMPORTED_MODULE_2__["LoginComponent"] },
    { path: 'registrati', component: _user_registration_user_registration_component__WEBPACK_IMPORTED_MODULE_3__["UserRegistrationComponent"] },
    { path: 'admin', component: _user_list_user_list_component__WEBPACK_IMPORTED_MODULE_7__["UserListComponent"], canActivate: [_login_auth_guardA__WEBPACK_IMPORTED_MODULE_9__["AuthGuardA"]] },
    { path: 'admin/:id', component: _user_list_user_list_component__WEBPACK_IMPORTED_MODULE_7__["UserListComponent"], canActivate: [_login_auth_guardA__WEBPACK_IMPORTED_MODULE_9__["AuthGuardA"]] }
];
...
/* harmony import */ var _login_auth_interceptor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./login/auth-interceptor */ "./src/app/login/auth-interceptor.ts");
/* harmony import */ var _app_routing_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./app-routing.module */ "./src/app/app-routing.module.ts");
/* harmony import */ var _myaccount_myaccount_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./myaccount/myaccount.component */ "./src/app/myaccount/myaccount.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _myaccount_myaccount_component__WEBPACK_IMPORTED_MODULE_11__["MyaccountComponent"]
        ],
        imports: [
        ...
        providers: [
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_13__["HTTP_INTERCEPTORS"], useClass: _login_auth_interceptor__WEBPACK_IMPORTED_MODULE_9__["AuthInterceptor"], multi: true }
        ],
...
let AuthGuardA = class AuthGuardA {
    ...
    canActivate(next, state) {
        ...
        // check if admin
        this.userService.getOneUser(localStorage.getItem('email'));
        return this.userService.getCurrentUserUpdateListener().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(e => {
            if (e.admin) {
                return true;
            }
            else {
...
MyaccountComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./myaccount.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/myaccount/myaccount.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./myaccount.component.css */ "./src/app/myaccount/myaccount.component.css")).default]
    })
], MyaccountComponent);
...
let UserListComponent = class UserListComponent {
    constructor(userService, cdRef, route, router) {
        this.userService = userService;
        this.cdRef = cdRef;
        this.route = route;
        this.router = router;
...
UserRegistrationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./user-registration.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/user-registration/user-registration.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./user-registration.component.css */ "./src/app/user-registration/user-registration.component.css")).default]
    })
...
let UserService = class UserService {
    ...
    addUser(user) {
        this.http.post(this.urlUser + "signup", user)
    ...
    getOneUser(email) {
        this.http.get(this.urlUser + "findme/" + email)
            .subscribe(resultData => {
            this.currentUser = resultData.user;
            var cloneUser = Object.assign({}, this.currentUser);
            this.userUpdated.next(cloneUser);
        }, err => {
        });
    }
    ...
    login(email, password) {
        ...
        this.http.post(this.urlUser + "login", authData)
            .subscribe(response => {
            if (response.token) {
...
module.exports = __webpack_require__(/*! /Users/tomas/Desktop/dance_frontend/src/main.ts */"./src/main.ts");
